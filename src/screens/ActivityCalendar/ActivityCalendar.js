...
//import {useStore} from 'react-native-calendars'
//import {Task} from 'react-native-calendars'
...
export default function ActivityCalendar({ navigation }) {
 ...
 /**  const onCreateView=()=>{
  ...
  return (
    ...
    <Fragment>
    <View><CustomHeader></CustomHeader></View>
      {selectedTask !== null && (
